...
export const HowItWorks = () => {
  ...
  return (
    <div id="how-it-works" className="min-h-screen pt-16 bg-background px-4 sm:px-6">
      <div className="mx-auto max-w-7xl">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-4xl sm:text-6xl font-bold leading-tight sm:leading-8 tracking-tight text-[#177E89] mb-6">
            How It Works
          </h2>
          <p className="mt-4 sm:mt-6 text-xl sm:text-2xl font-bold tracking-tight text-[#177E89] italic">
            Start Earning in 3 Simple Steps
          </p>
        </div>
        <div className="mx-auto mt-6 sm:mt-12 max-w-2xl lg:mt-16 lg:max-w-none">
